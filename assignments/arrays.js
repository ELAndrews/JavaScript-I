...
function idSearch (idNum){
  for (let i in inventory) {
    if (inventory[i].id === idNum){
      return "Car " + idNum + " is a " + inventory[i].car_year + ", " + inventory[i].car_make + ", " + inventory[i].car_model + ".";
    }
  }
};

console.log(idSearch(33));
...
let lastCar = () => {
  ...
  return car.car_make + ", " + car.car_model;
}
console.log(lastCar());
